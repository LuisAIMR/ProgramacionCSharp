...
namespace GUI
{
    public partial class frmProducto : Form
    {
        ...
        {
            frmPantallaPrincipal men = new frmPantallaPrincipal();

            if (men.menVertical.Visible == false)
            {
                men.menVertical.Visible = true;
            }
            else if (men.menVertical.Visible == true)
            {
                men.menVertical.Visible = false;
            }
        }
